...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::unprepared('CREATE TRIGGER tambah_berita AFTER INSERT ON tberita FOR EACH ROW BEGIN INSERT INTO logs(logs) VALUES(concat(\'Judul berita \', NEW.judul_berita, \' \', \'telah ditambahkan pada\', \' \', NOW())); END;');
        DB::unprepared('CREATE TRIGGER edit_berita AFTER UPDATE ON tberita FOR EACH ROW BEGIN INSERT INTO logs(logs) VALUES (concat(\'Judul berita \', OLD.judul_berita, \' \', \'telah diperbarui menjadi berita dengan judul \', \' \', NEW.judul_berita, \' \', \'pada\', \' \', NOW())); END;');
        DB::unprepared('CREATE TRIGGER hapus_berita AFTER DELETE ON tberita FOR EACH ROW BEGIN INSERT INTO logs(logs) VALUES (concat(\'Judul berita \', OLD.judul_berita, \' \', \'telah dihapus pada\', \' \', NOW())); END;');
    }
