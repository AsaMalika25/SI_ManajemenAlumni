    ...
    <div class="card" style="width: 85.86762075134168vh; margin:auto; border-radius: 2.862254025044723vh; margin-top: 2rem; margin-bottom: 14.311270125223613vh;">
        <div class="card-body">
          ...
          <div class="text-center">
            <h1 class="h4 text-gray-900 mb-4 font-nav">Form Tambah</h1>
            <br>
          </div>
          <!-- end text judul -->
          ...
          <form action="/tambah" method="post">
            <div class="mb-3">
              <label for="inputJam" class="form-label font-form">Waktu Kehadiran</label>
              <input type="time" class="form-control" id="inputJam" name="waktu" style="border-radius: 1.8635607321131447vh;" required>
            </div>
            <div class="mb-3" >
              <label for="inputNama" class="form-label font-form">Nama</label>
              <input type="text" class="form-control" id="inputNama" name="nama" style="border-radius:  1.8635607321131447vh;" required>
            </div>
            <div class="mb-3">
              <label for="inputNomorHp" class="form-label font-form">Nomor Handphone</label>
              <input type="text" class="form-control" id="inputNomorHp" name="nomor" style="border-radius:  1.8635607321131447vh;" required>
            </div>
            <div class="mb-3">
              <label for="inputAlamat" class="form-label font-form">Alamat</label>
              <textarea class="form-control" name="alamat" style="resize:none; border-radius: 1.8635607321131447vh; width: 80.14311270125224vh; height: 11.449016100178891vh" id="inputAlamat" rows="3" required></textarea>
            </div>
