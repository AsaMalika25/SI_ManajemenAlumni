...
<div class="container mt-5 align-item-center" style="background-repeat: no-repeat; background-size: cover; background-position: center; z-index: -10;">
        ...
        <br>
          ...
          <div class="tab-content" id="pills-tabContent">   
                ...
                <div class="card" style="width: 123.02284710017575vh; margin:auto; border-radius: 2.862254025044723vh; margin-bottom: 5.311270125223613vh;">
                    <div class="card-body">  
                      ...
                      <table class="table DataTable" >
                        ...
                        <!-- end head tabel -->
                        <h3 class="card-title"> Jumlah : {{ $jumlahJenisBerita ?? 0 }}</h3>
                        <!-- body tabel -->
                        <tbody>
