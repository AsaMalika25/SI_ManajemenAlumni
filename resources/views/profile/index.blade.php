        ...
        <div class="card" style="width: 30rem; margin:auto; border-radius: 2.862254025044723vh; margin-bottom: 14.311270125223613vh;">
            <div class="card-body">  
                ...
                <div style="margin: 5% 3%;" class="justify-content-center d-flex">
                    <h2 class="txt-detail"><b>Hello, Adhinda!</b></h2>
                </div>
                    ...
                    <div class="justify-content-center d-flex mt-5">
                        ...
                        <div class="" style="width: 50%;">
                            <h6 class="text-detail">Adhinda Zahra Dinanti</h6>		
                            <h6 class="text-detail">Mars, 40 April</h6>
                            <h6 class="text-detail">Kota Mars, 17167</h6>
                            <h6 class="text-detail">Ngeliatin dia</h6>
                        </div>
                    </div>
