...
<nav class="main-menu" style="z-index:999" > 
            ...
            <li>                                   
                <a href="dashboard" style="height: 30px;">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-house-door-fill" viewBox="0 0 16 16" style="margin-left: 24%;">
            ...
            @if (Auth::user()->role == 'superadmin' || Auth::user()->role == 'kaprog')
                <li>                                 
                    <a href="alumni"  style="height: 30px;">
           ...
           @if (Auth::user()->role == 'superadmin')
            <li>                                 
                <a href="list_akun"  style="height: 30px;">
            ...
            <li>                                 
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-text-left" viewBox="0 0 16 16" style="margin-left: 24%;">
            ...
            <li>                                 
                <a href="angkatan" style="height: 30px;">
            ...
            <li>                                 
                <a href="kelas" style="height: 30px;">
            ...
            <li>                                 
                <a href="jurusan" style="height: 30px;">
            ...
            <li>                                 
                <a href="wirausaha" style="height: 30px;">
                <svg xmlns="http://www.w3.org/2000/svg" widht="20" height="20" fill="currentColor" class="bi bi-cash-coin" viewBox="0 0 16 16" style="margin-left: 24%;">
            ...
            <li>                                 
                <a href="kuliah" style="height: 30px;">
                <svg xmlns="http://www.w3.org/2000/svg" widht="20" height="20" fill="currentColor" class="bi bi-mortarboard-fill" viewBox="0 0 16 16" style="margin-left: 24%;">
            ...
            <li>                                 
                <a href="kerja" style="height: 30px;">
                <svg xmlns="http://www.w3.org/2000/svg" widht="20" height="20" fill="currentColor" class="bi bi-suitcase-lg-fill" viewBox="0 0 16 16" style="margin-left: 24%;">
            ...
            <li>
                <a href="berita" style="height: 30px;">
                <svg xmlns="http://www.w3.org/2000/svg" widht="20" height="20" fill="currentColor" class="bi bi-newspaper" viewBox="0 0 16 16" style="margin-left: 24%;">
            ...
            <li>
                <a href="jenis_berita" style="height: 30px;">
                <svg xmlns="http://www.w3.org/2000/svg" widht="20" height="20" fill="currentColor" class="bi bi-lightbulb-fill" viewBox="0 0 16 16" style="margin-left: 24%;">
           ...
           @endif
            ...
            <li>
                <a href="{{url('logout')}}" style="height: 30px;">
                <svg xmlns="http://www.w3.org/2000/svg" widht="20" height="20" fill="currentColor" class="bi bi-box-arrow-left" viewBox="0 0 16 16" style="margin-left: 24%;">
