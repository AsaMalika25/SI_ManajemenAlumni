            ...
            <div class="card-body">  
                ...
                <div class="box-txt d-flex">
                    <div class="col-4" style="text-align: center; padding-top: 20px;"> 
                      @if($tberita->file)
                          <img src="{{ url('foto') . '/' . $tberita->file }} "
                              style="max-width: 80%; height:280px; border-radius: 5%;" />
                      @endif

                        <button type="button" class="btn btn-warning" style="margin-top: 20px;"><a href="{{url('tberita')}}" class="align-item-center">
                    ...
                    <div class="col-7" style="width: 25%; margin-left: 50px; margin-top: 3%;" >
                        ...
                        <h6 class="text-info " style="color: #4378ff;">Jenis Berita<b></b></h6>
                    ...
                    <div class="" style="width: 30%; margin-top: 3%;">
                        <h6 class="text-info" style="color: #4378ff;"><b>Keterangan Berita</b></h6>		
                            <p class="text-detail text-dark">{{$tberita->ket_berita}}</p>
                        <!-- <h6 class="text-info" style="color: #4378ff;"><b>Alamat</b></h6>
                            <p class="text-detail text-dark">{{$tberita->alamat}}</p>
                        <h6 class="text-info" style="color: #4378ff;"><b>Email</b></h6>
                            <p class="text-detail text-dark">{{$tberita->email}}</p>
                        <h6 class="text-info" style="color: #4378ff;"><b>Tanggal lahir</b></h6>
                            <p class="text-detail text-dark">{{$tberita->tgl_lahir}}</p> -->
                    </div>
                </div>
                </div>
                </main>
